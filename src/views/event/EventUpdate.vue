...
<input type="text" v-model="event_title" class="w3-input w3-border" placeholder="제목을 입력해주세요.">
<hr>
<label for="event_author">작성자</label>
<input type="text" v-model="event_author" class="w3-input w3-border" placeholder="작성자를 입력해주세요." v-if="idx === undefined">
<label for="created_at">수정일</label>
<input type="date" v-model="created_at" class="w3-input w3-border" placeholder="수정일자">
<hr>
